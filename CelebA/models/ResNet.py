...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, isometric_map = True, num_classes=N_CLASS, nc=NC, ngpu = 1):
        ...
        self.classifier_1 = nn.Sequential(
                nn.Linear(512*block.expansion, IMG_SIZE*IMG_SIZE*NC),
                )
        self.classifier_2 = nn.Sequential(
                # nn.BatchNorm1d(IMG_SIZE*IMG_SIZE*NC),
                # nn.ReLU(),
                nn.Linear(IMG_SIZE*IMG_SIZE*NC, num_classes)
                )
